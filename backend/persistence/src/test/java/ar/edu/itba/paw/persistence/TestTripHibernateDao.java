...
public class TestTripHibernateDao {
    ...
    private static final User user = new User("firstname", "lastname", "test@gmail.com", "secretPsw", LocalDate.now(), "Argentina" , "M", "asdasdasd");
    ...
    public void testCreate() {
        Trip trip = td.create(user, place, NAME, DESC, START_DATE, END_DATE, IS_PRIVATE);
